...
class SpecFreqMasking(BaseWaveformTransform):

    """
    Wrapper for the frequency masking augmentation from torchaudio. This is so that it can be used as part of an augmentation set.

    Reference:
    https://pytorch.org/audio/stable/transforms.html#frequencymasking
    """
    ...
    def __init__(
        ...
        self.tform = torchaudio.transforms.FrequencyMasking(freq_mask_param=self.freq_mask_param,
